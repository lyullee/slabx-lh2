...
**The accessible FFI report does not tabulate humidity.** Every FFI run here
therefore states an assumed value. Across RH 0--100 %, Tests 1 and 6 move by
54 and 57 % in LFL distance and the bracket count changes from three to five
of six. The two horizontal trials nevertheless remain under-predicted at every
humidity. The distance result must be reported with this sensitivity, not as
...
#: trial -> wind [m/s], T [C], RH [%], from the E3.5 conditions sheet,
#: averaged over each release window. Transcribed here because the sheet
#: itself is a measurement file and is not distributed; **these are settings
#: and ambient readings, not results.**
_E35_MET = {3: (3.600, 17.13, 80.67), 4: (1.833, 16.70, 81.00),
            6: (3.900, 17.70, 72.00), 7: (2.500, 17.00, 76.00),
            8: (2.367, 13.33, 70.67), 10: (2.467, 15.43, 58.00),
            11: (2.700, 15.63, 54.33), 12: (2.700, 16.37, 52.67),
            13: (1.500, 15.30, 57.00), 14: (1.933, 14.87, 59.33),
            16: (4.167, 12.77, 57.33), 17: (2.867, 13.13, 57.00),
            19: (1.600, 14.73, 53.67), 20: (0.567, 14.73, 53.67),
            22: (1.700, 15.85, 51.00), 23: (1.700, 15.50, 53.67),
            24: (1.900, 15.77, 53.00)}
