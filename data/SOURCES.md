...
an assumed value. Across the full RH = 0--100 % sensitivity sweep, the two
horizontal releases remain underpredicted at 30 m, but the observation-bracket
count changes from three of six at RH <= 50 % to five of six at RH >= 75 %.
Neither the LFL distance nor the bracket count is described as humidity
independent.
...
| gives | Tables 3--4 conditions for twelve trials |
